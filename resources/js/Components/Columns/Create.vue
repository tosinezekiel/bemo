    ...
    <div class="py-12 mr-4 w-80">
        <div class="divide-y divide-gray-200 overflow-hidden rounded-md shadow">
            ...
            <div class="my-2 px-2" v-else>
                <div class="mt-1">
                    <input type="email" name="email" id="email" placeholder="Enter column title" class="block w-full px-2 py-2 rounded-sm border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm"/>
                </div>
                <div class="flex mt-2">
